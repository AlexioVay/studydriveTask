...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fav: function fav(id) {
      if (this.$userId) {
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("fav-" + id, {
          userId: this.$userId
    ...
    fetchData: function fetchData() {
      ...
      Vue.prototype.$weekday = document.querySelector("meta[name='weekday']").getAttribute('content');
      if (this.$weekday) Vue.prototype.$weekdayString = '&weekday=1';
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('json?page=1' + this.$weekdayString).then(function (response) {
    ...
    paginateCallback: function paginateCallback(pageNumber) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("json?page=" + pageNumber + this.$weekdayString).then(function (response) {
      ...
      _c(
        ...
        [
          ...
          _vm._l(_vm.results, function(result) {
            return result.url
              ? _c("a", { key: result.id }, [
                  _c("img", { attrs: { src: result.url, alt: result.title } }),
                  _vm._v(" "),
                  _c(
                    "span",
                    {
                    ...
                    [
                      ...
                      _vm._v(" "),
                      result.favs
                        ? _c("abbr", [_vm._v(_vm._s(result.favs))])
                        : _vm._e()
                    ]
                  )
                ])
          ...
          _vm._l(_vm.results, function(result) {
            return result.name
              ? _c("a", { key: result.id }, [
                  ...
                  _c("br"),
                  _vm._v(" "),
                  _c("i", { staticClass: "material-icons amaranth" }, [
                    _vm._v("favorite")
                  ]),
                  _vm._v(" " + _vm._s(result.favs) + " Likes\n      ")
                ])
              : _vm._e()
          })
        ],
...
/***/ 0:
/*!**************************************************************************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/sass/app.sass ./resources/sass/_global.sass ./resources/sass/mqueries.sass ***!
  \**************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\xampp\htdocs\studydrive\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\xampp\htdocs\studydrive\resources\sass\app.sass */"./resources/sass/app.sass");
__webpack_require__(/*! C:\xampp\htdocs\studydrive\resources\sass\_global.sass */"./resources/sass/_global.sass");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\studydrive\resources\sass\mqueries.sass */"./resources/sass/mqueries.sass");
